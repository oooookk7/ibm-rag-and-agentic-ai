...
4. **Create a .env file in the root directory with the following keys**:
   ```bash
    ...
    HUGGINGFACE_VISION_MODEL=Qwen/Qwen2.5-VL-72B-Instruct:novita
    HUGGINGFACE_HTTP_TIMEOUT=240
    HUGGINGFACE_MAX_TOKENS=1400
    HUGGINGFACE_TOOL_MAX_TOKENS=1200
   ```
## Usage
### Run the Application
